...
def model_trainer_v2(path_to_dataset, train_indices_filepath, val_indices_filepath, fold=None):
    ...
    model_dir = '/Users/wanghanlin/Desktop/water_crisis-main/src/BERT_res'
    #model_dir = '/home/sayantan/Desktop/projects/ganga-tripadvisor/final_training/bert_v5'
    if fold:
        model_dir = f'/Users/wanghanlin/Desktop/water_crisis-main/src/bert_simple_kfold_v5'
...
if __name__ == '__main__':
    ...
    train_indices_filepath = ""    # insert training indices in a plaintext file (newline separated)  
    val_indices_filepath = ""    # insert training indices in a plaintext file (newline separated)
    model_trainer_v2(path_to_dataset, train_indices_filepath, val_indices_filepath, fold=None)
